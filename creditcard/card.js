// const form = document.querySelector('#cardPaymentFront');
...
//   if (isNaN(cardNumber)) {
//     errorMsg.textContent = 'Please enter a valid card number (numbers only).';
//     return false; 
//   }
...
document.querySelector("#cardPaymentFront").addEventListener('submit', submitHandler)
